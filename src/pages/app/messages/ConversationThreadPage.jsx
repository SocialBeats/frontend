...
import { connectMessagingSocket, onMessageNew, offMessageNew,  disconnectMessagingSocket } from '@/services/messagingSocket';
...
export default function ConversationThreadPage() {
  ...
  useEffect(() => {
    ...
    const handler = ({ conversationId: incomingConvoId, message }) => {
      ...
      console.log("[WS] message:new received", incomingConvoId, message?._id);
    };
